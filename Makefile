...
TEST_SERVER_ENV := DISABLE_RATE_LIMITS=true DISABLE_USAGE_LIMITS=true TESTING=true EMAIL_ENABLED=false SMS_ENABLED=false SKIP_TEST_DB_FIXTURES=true DATABASE_URL=$(TEST_DB_URL)
