...
class Solution(Base):
    ...
    scope_start = Column(Date, nullable=True)
    scope_end = Column(Date, nullable=True)
    scope_event_ids = Column(JSONType, nullable=True)
    scope_fingerprint = Column(String, nullable=True)
    created_at = Column(DateTime, default=utcnow)
