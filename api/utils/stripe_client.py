...
class StripeClient:
    ...
    def create_subscription(
        ...
        try:
            ...
            log_stripe_error(
                e,
                "create_subscription",
                {"customer_id": customer_id, "price_id": price_id, "trial_days": trial_days},
            )
            error_info = handle_stripe_error(e)
            return {
                "success": False,
    ...
    def attach_payment_method(
        ...
        try:
            ...
            return {"success": True, "payment_method": payment_method, "message": message}
    ...
    def verify_webhook_signature(self, payload: bytes, signature: str) -> dict[str, Any]:
        ...
        try:
            ...
            log_stripe_error(e, "verify_webhook_signature", {"signature_present": bool(signature)})
            error_info = handle_stripe_error(e)
            return {
                "success": False,
                "message": error_info["user_message"],
