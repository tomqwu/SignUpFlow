...
- #279/#289 FLOW-1: the machine-readable playbook coverage manifest now binds
  ...
  BO-01 through BO-03 are automated: each domain browser flow creates its organization
  ...
  proves solver exclusion across twelve API-seeded events. Repeated-event setup remains
  an explicitly API-seeded browser-test step.
