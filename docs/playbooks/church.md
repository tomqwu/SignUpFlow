...
| CH-07 | Member acknowledgement | Open draft as assigned member, then publish and accept | Draft absent from member schedule; published assignment visible and acceptance confirmed in browser |
