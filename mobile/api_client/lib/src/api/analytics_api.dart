...
class AnalyticsApi {
  ...
  Future<Response<JsonObject>> getBurnoutRisk({
    ...
    final _path = r'/api/v1/analytics/{org_id}/burnout-risk'.replaceAll('{' r'org_id' '}', encodeQueryParameter(_serializers, orgId, const FullType(String)).toString());
    ...
    final _queryParameters = <String, dynamic>{
      if (threshold != null) r'threshold': encodeQueryParameter(_serializers, threshold, const FullType(int)),
    };
  ...
  Future<Response<JsonObject>> getScheduleHealth({
    ...
    final _path = r'/api/v1/analytics/{org_id}/schedule-health'.replaceAll('{' r'org_id' '}', encodeQueryParameter(_serializers, orgId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> getVolunteerStats({
    ...
    final _path = r'/api/v1/analytics/{org_id}/volunteer-stats'.replaceAll('{' r'org_id' '}', encodeQueryParameter(_serializers, orgId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
