...
class AssignmentsApi {
  ...
  Future<Response<AssignmentResponse>> acceptAssignment({
    ...
    final _path = r'/api/v1/assignments/{assignment_id}/accept'.replaceAll('{' r'assignment_id' '}', encodeQueryParameter(_serializers, assignmentId, const FullType(int)).toString());
    ...
    AssignmentResponse? _responseData;
  ...
  Future<Response<AssignmentResponse>> declineAssignment({
    ...
    final _path = r'/api/v1/assignments/{assignment_id}/decline'.replaceAll('{' r'assignment_id' '}', encodeQueryParameter(_serializers, assignmentId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AssignmentDeclineRequest);
      _bodyData = _serializers.serialize(assignmentDeclineRequest, specifiedType: _type);
  ...
  Future<Response<ListResponseAssignmentResponse>> listMyAssignments({
    ...
    final _path = r'/api/v1/assignments/me';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ListResponseAssignmentResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponseAssignmentResponse),
      ) as ListResponseAssignmentResponse;
    ...
    return Response<ListResponseAssignmentResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AssignmentResponse>> requestSwap({
    ...
    final _path = r'/api/v1/assignments/{assignment_id}/swap-request'.replaceAll('{' r'assignment_id' '}', encodeQueryParameter(_serializers, assignmentId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AssignmentSwapRequest);
      _bodyData = _serializers.serialize(assignmentSwapRequest, specifiedType: _type);
