...
class AuthApi {
  ...
  Future<Response<AuthResponse>> changePassword({
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> checkEmail({
    ...
    final _path = r'/api/v1/auth/check-email';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> requestPasswordReset({
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> resetPassword({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(passwordResetConfirm, specifiedType: _type);
