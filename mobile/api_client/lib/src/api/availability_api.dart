...
class AvailabilityApi {
  ...
  Future<Response<AvailabilityExceptionResponse>> addException({
    ...
    final _path = r'/api/v1/availability/{person_id}/exceptions'.replaceAll('{' r'person_id' '}', encodeQueryParameter(_serializers, personId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(AvailabilityExceptionCreate);
      _bodyData = _serializers.serialize(availabilityExceptionCreate, specifiedType: _type);
    ...
    AvailabilityExceptionResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AvailabilityExceptionResponse),
      ) as AvailabilityExceptionResponse;
    ...
    return Response<AvailabilityExceptionResponse>(
      data: _responseData,
  ...
  Future<Response<JsonObject>> addTimeoff({
    ...
    final _path = r'/api/v1/availability/{person_id}/timeoff'.replaceAll('{' r'person_id' '}', encodeQueryParameter(_serializers, personId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TimeOffCreate);
      _bodyData = _serializers.serialize(timeOffCreate, specifiedType: _type);
  ...
  Future<Response<void>> clearRrule({
    ...
    final _path = r'/api/v1/availability/{person_id}/rrule'.replaceAll('{' r'person_id' '}', encodeQueryParameter(_serializers, personId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> createAvailability({
    ...
    final _path = r'/api/v1/availability/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> deleteException({
    ...
    final _path = r'/api/v1/availability/{person_id}/exceptions/{exception_id}'.replaceAll('{' r'person_id' '}', encodeQueryParameter(_serializers, personId, const FullType(String)).toString()).replaceAll('{' r'exception_id' '}', encodeQueryParameter(_serializers, exceptionId, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> deleteTimeoff({
    ...
    final _path = r'/api/v1/availability/{person_id}/timeoff/{timeoff_id}'.replaceAll('{' r'person_id' '}', encodeQueryParameter(_serializers, personId, const FullType(String)).toString()).replaceAll('{' r'timeoff_id' '}', encodeQueryParameter(_serializers, timeoffId, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AvailabilityRruleResponse>> getRrule({
    ...
    AvailabilityRruleResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AvailabilityRruleResponse),
      ) as AvailabilityRruleResponse;
    ...
    return Response<AvailabilityRruleResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<AvailabilityExceptionResponse>>> listExceptions({
    ...
    BuiltList<AvailabilityExceptionResponse>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(AvailabilityExceptionResponse)]),
      ) as BuiltList<AvailabilityExceptionResponse>;
    ...
    return Response<BuiltList<AvailabilityExceptionResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AvailabilityRruleResponse>> setRrule({
    ...
    try {
      const _type = FullType(AvailabilityRruleUpdate);
      _bodyData = _serializers.serialize(availabilityRruleUpdate, specifiedType: _type);
