...
class CalendarApi {
  ...
  Future<Response<CalendarTokenResetResponse>> adminResetCalendarToken({
    ...
    final _path = r'/api/v1/calendar/{person_id}/admin-reset'.replaceAll('{' r'person_id' '}', encodeQueryParameter(_serializers, personId, const FullType(String)).toString());
    ...
    CalendarTokenResetResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CalendarTokenResetResponse),
      ) as CalendarTokenResetResponse;
    ...
    return Response<CalendarTokenResetResponse>(
      data: _responseData,
  ...
  Future<Response<JsonObject>> calendarFeed({
    ...
    final _path = r'/api/v1/calendar/feed/{token}'.replaceAll('{' r'token' '}', encodeQueryParameter(_serializers, token, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> exportOrganizationEvents({
    ...
    final _path = r'/api/v1/calendar/org/export';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> exportPersonalSchedule({
    ...
    final _path = r'/api/v1/calendar/export';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<CalendarSubscriptionResponse>> getSubscriptionUrl({
    ...
    final _path = r'/api/v1/calendar/subscribe';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    CalendarSubscriptionResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CalendarSubscriptionResponse),
      ) as CalendarSubscriptionResponse;
    ...
    return Response<CalendarSubscriptionResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CalendarTokenResetResponse>> resetCalendarToken({
    ...
    final _path = r'/api/v1/calendar/reset-token';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
