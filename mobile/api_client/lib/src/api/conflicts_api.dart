...
class ConflictsApi {
  ...
  const ConflictsApi(this._dio, this._serializers);
  ...
  Future<Response<ConflictCheckResponse>> checkConflicts({
    ...
    final _path = r'/api/v1/conflicts/check';
    ...
    try {
      const _type = FullType(ConflictCheckRequest);
      _bodyData = _serializers.serialize(conflictCheckRequest, specifiedType: _type);
    ...
    ConflictCheckResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConflictCheckResponse),
    ...
    return Response<ConflictCheckResponse>(
      data: _responseData,
  ...
  /// * [personId] - Optional filter to a single person
  ...
  Future<Response<ListResponseConflictType>> listConflicts({
    ...
    final _path = r'/api/v1/conflicts/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ListResponseConflictType? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponseConflictType),
      ) as ListResponseConflictType;
    ...
    return Response<ListResponseConflictType>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
