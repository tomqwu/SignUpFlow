...
class ConstraintsApi {
  ...
  const ConstraintsApi(this._dio, this._serializers);
  ...
  Future<Response<ConstraintResponse>> createConstraint({
    ...
    final _path = r'/api/v1/constraints/';
    ...
    try {
      const _type = FullType(ConstraintCreate);
      _bodyData = _serializers.serialize(constraintCreate, specifiedType: _type);
    ...
    ConstraintResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConstraintResponse),
    ...
    return Response<ConstraintResponse>(
      data: _responseData,
  ...
  Future<Response<void>> deleteConstraint({
    ...
    final _path = r'/api/v1/constraints/{constraint_id}'.replaceAll('{' r'constraint_id' '}', encodeQueryParameter(_serializers, constraintId, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [constraintType] - Filter by type (hard/soft)
  ...
  Future<Response<ListResponseConstraintResponse>> listConstraints({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'constraint_type': encodeQueryParameter(_serializers, constraintType, const FullType(String)),
    ...
    ListResponseConstraintResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponseConstraintResponse),
      ) as ListResponseConstraintResponse;
    ...
    return Response<ListResponseConstraintResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ConstraintResponse>> updateConstraint({
    ...
    try {
      const _type = FullType(ConstraintUpdate);
      _bodyData = _serializers.serialize(constraintUpdate, specifiedType: _type);
