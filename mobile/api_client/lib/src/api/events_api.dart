...
class EventsApi {
  ...
  Future<Response<EventResponse>> createEvent({
    ...
    try {
      const _type = FullType(EventCreate);
      _bodyData = _serializers.serialize(eventCreate, specifiedType: _type);
  ...
  Future<Response<void>> deleteEvent({
    ...
    final _path = r'/api/v1/events/{event_id}'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> getAllAssignments({
    ...
    final _path = r'/api/v1/events/assignments/all';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<AvailablePerson>>> getAvailablePeople({
    ...
    final _path = r'/api/v1/events/{event_id}/available-people'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<AvailablePerson>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(AvailablePerson)]),
      ) as BuiltList<AvailablePerson>;
    ...
    return Response<BuiltList<AvailablePerson>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [startAfter] - Filter events starting after this time
  /// * [startBefore] - Filter events starting before this time
  /// * [q] - Case-insensitive search on event type and id
  /// * [status] - Filter by computed status: 'upcoming', 'past', or 'ongoing'
  ...
  Future<Response<ListResponseEventResponse>> listEvents({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'start_after': encodeQueryParameter(_serializers, startAfter, const FullType(DateTime)),
      r'start_before': encodeQueryParameter(_serializers, startBefore, const FullType(DateTime)),
    ...
    ListResponseEventResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponseEventResponse),
      ) as ListResponseEventResponse;
    ...
    return Response<ListResponseEventResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<JsonObject>> manageAssignment({
    ...
    final _path = r'/api/v1/events/{event_id}/assignments'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AssignmentRequest);
      _bodyData = _serializers.serialize(assignmentRequest, specifiedType: _type);
  ...
  Future<Response<EventResponse>> updateEvent({
    ...
    try {
      const _type = FullType(EventUpdate);
      _bodyData = _serializers.serialize(eventUpdate, specifiedType: _type);
  ...
  Future<Response<BuiltMap<String, JsonObject>>> validateEvent({
    ...
    final _path = r'/api/v1/events/{event_id}/validation'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
