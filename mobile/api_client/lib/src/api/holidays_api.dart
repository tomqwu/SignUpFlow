...
class HolidaysApi {
  ...
  Future<Response<HolidayBulkImportResponse>> bulkImportHolidays({
    ...
    final _path = r'/api/v1/holidays/bulk';
    ...
    try {
      const _type = FullType(HolidayBulkImport);
      _bodyData = _serializers.serialize(holidayBulkImport, specifiedType: _type);
    ...
    HolidayBulkImportResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(HolidayBulkImportResponse),
      ) as HolidayBulkImportResponse;
    ...
    return Response<HolidayBulkImportResponse>(
      data: _responseData,
  ...
  Future<Response<HolidayResponse>> createHoliday({
    ...
    try {
      const _type = FullType(HolidayCreate);
      _bodyData = _serializers.serialize(holidayCreate, specifiedType: _type);
    ...
    HolidayResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(HolidayResponse),
      ) as HolidayResponse;
  ...
  Future<Response<void>> deleteHoliday({
    ...
    final _path = r'/api/v1/holidays/{holiday_id}'.replaceAll('{' r'holiday_id' '}', encodeQueryParameter(_serializers, holidayId, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ListResponseHolidayResponse>> listHolidays({
    ...
    ListResponseHolidayResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponseHolidayResponse),
      ) as ListResponseHolidayResponse;
    ...
    return Response<ListResponseHolidayResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<HolidayResponse>> updateHoliday({
    ...
    try {
      const _type = FullType(HolidayUpdate);
      _bodyData = _serializers.serialize(holidayUpdate, specifiedType: _type);
