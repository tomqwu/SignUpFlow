...
class InvitationsApi {
  ...
  Future<Response<InvitationAcceptResponse>> acceptInvitation({
    ...
    final _path = r'/api/v1/invitations/{token}/accept'.replaceAll('{' r'token' '}', encodeQueryParameter(_serializers, token, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(InvitationAccept);
      _bodyData = _serializers.serialize(invitationAccept, specifiedType: _type);
    ...
    InvitationAcceptResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InvitationAcceptResponse),
      ) as InvitationAcceptResponse;
    ...
    return Response<InvitationAcceptResponse>(
      data: _responseData,
  ...
  /// * [q] - Case-insensitive search on email and name
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<ListResponseInvitationResponse>> listInvitations({
    ...
    ListResponseInvitationResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponseInvitationResponse),
      ) as ListResponseInvitationResponse;
    ...
    return Response<ListResponseInvitationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<InvitationResponse>> resendInvitation({
    ...
    final _path = r'/api/v1/invitations/{invitation_id}/resend'.replaceAll('{' r'invitation_id' '}', encodeQueryParameter(_serializers, invitationId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<InvitationVerify>> verifyInvitation({
    ...
    final _path = r'/api/v1/invitations/{token}'.replaceAll('{' r'token' '}', encodeQueryParameter(_serializers, token, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    InvitationVerify? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InvitationVerify),
      ) as InvitationVerify;
    ...
    return Response<InvitationVerify>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
