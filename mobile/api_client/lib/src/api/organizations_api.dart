...
class OrganizationsApi {
  ...
  Future<Response<OrganizationResponse>> cancelOrganization({
    ...
    final _path = r'/api/v1/organizations/{org_id}/cancel'.replaceAll('{' r'org_id' '}', encodeQueryParameter(_serializers, orgId, const FullType(String)).toString());
  ...
  Future<Response<void>> deleteOrganization({
    ...
    final _path = r'/api/v1/organizations/{org_id}'.replaceAll('{' r'org_id' '}', encodeQueryParameter(_serializers, orgId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ListResponseOrganizationResponse>> listOrganizations({
    ...
    final _queryParameters = <String, dynamic>{
      if (includeCancelled != null) r'include_cancelled': encodeQueryParameter(_serializers, includeCancelled, const FullType(bool)),
    ...
    ListResponseOrganizationResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponseOrganizationResponse),
      ) as ListResponseOrganizationResponse;
    ...
    return Response<ListResponseOrganizationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OrganizationResponse>> restoreOrganization({
    ...
    final _path = r'/api/v1/organizations/{org_id}/restore'.replaceAll('{' r'org_id' '}', encodeQueryParameter(_serializers, orgId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OrganizationResponse>> updateOrganization({
    ...
    try {
      const _type = FullType(OrganizationUpdate);
      _bodyData = _serializers.serialize(organizationUpdate, specifiedType: _type);
