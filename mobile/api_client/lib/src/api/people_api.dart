...
class PeopleApi {
  ...
  Future<Response<BulkImportResponse>> bulkImportPeople({
    ...
    final _path = r'/api/v1/people/bulk';
    ...
    BulkImportResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BulkImportResponse),
  ...
  Future<Response<PersonResponse>> createPerson({
    ...
    try {
      const _type = FullType(PersonCreate);
      _bodyData = _serializers.serialize(personCreate, specifiedType: _type);
  ...
  Future<Response<void>> deletePerson({
    ...
    final _path = r'/api/v1/people/{person_id}'.replaceAll('{' r'person_id' '}', encodeQueryParameter(_serializers, personId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PersonResponse>> getCurrentPerson({
    ...
    final _path = r'/api/v1/people/me';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [role] - Filter by role
  /// * [q] - Case-insensitive search across name and email
  /// * [status] - Filter by Person.status (active/inactive/invited)
  ...
  Future<Response<ListResponsePersonResponse>> listPeople({
    ...
    ListResponsePersonResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponsePersonResponse),
      ) as ListResponsePersonResponse;
    ...
    return Response<ListResponsePersonResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PersonResponse>> updateCurrentPerson({
    ...
    try {
      const _type = FullType(PersonUpdate);
      _bodyData = _serializers.serialize(personUpdate, specifiedType: _type);
