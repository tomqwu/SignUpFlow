...
class RecurringEventsApi {
  ...
  const RecurringEventsApi(this._dio, this._serializers);
  ...
  Future<Response<RecurringSeriesResponse>> createRecurringSeries({
    ...
    final _path = r'/api/v1/recurring-series';
    ...
    try {
      const _type = FullType(RecurringSeriesCreate);
      _bodyData = _serializers.serialize(recurringSeriesCreate, specifiedType: _type);
    ...
    RecurringSeriesResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RecurringSeriesResponse),
      ) as RecurringSeriesResponse;
    ...
    return Response<RecurringSeriesResponse>(
      data: _responseData,
  ...
  Future<Response<JsonObject>> deleteRecurringSeries({
    ...
    final _path = r'/api/v1/recurring-series/{series_id}'.replaceAll('{' r'series_id' '}', encodeQueryParameter(_serializers, seriesId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> getSeriesOccurrences({
    ...
    final _path = r'/api/v1/recurring-series/{series_id}/occurrences'.replaceAll('{' r'series_id' '}', encodeQueryParameter(_serializers, seriesId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [orgId] - Organization ID
  /// * [activeOnly] - Only return active series
  ...
  Future<Response<ListResponseRecurringSeriesResponse>> listRecurringSeries({
    ...
    ListResponseRecurringSeriesResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponseRecurringSeriesResponse),
      ) as ListResponseRecurringSeriesResponse;
    ...
    return Response<ListResponseRecurringSeriesResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<OccurrencePreview>>> previewOccurrences({
    ...
    final _path = r'/api/v1/recurring-series/preview';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<OccurrencePreview>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(OccurrencePreview)]),
      ) as BuiltList<OccurrencePreview>;
    ...
    return Response<BuiltList<OccurrencePreview>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
