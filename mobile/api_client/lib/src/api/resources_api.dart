...
class ResourcesApi {
  ...
  Future<Response<ResourceResponse>> createResource({
    ...
    ResourceResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ResourceResponse),
      ) as ResourceResponse;
  ...
  Future<Response<void>> deleteResource({
    ...
    final _path = r'/api/v1/resources/{resource_id}'.replaceAll('{' r'resource_id' '}', encodeQueryParameter(_serializers, resourceId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [orgId] - Organization ID — required (single-tenant scope)
  ...
  Future<Response<ListResponseResourceResponse>> listResources({
    ...
    ListResponseResourceResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponseResourceResponse),
      ) as ListResponseResourceResponse;
    ...
    return Response<ListResponseResourceResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
