...
class SolverApi {
  ...
  const SolverApi(this._dio, this._serializers);
  ...
  Future<Response<SolveResponse>> solveSchedule({
    ...
    final _path = r'/api/v1/solver/solve';
    ...
    try {
      const _type = FullType(SolveRequest);
      _bodyData = _serializers.serialize(solveRequest, specifiedType: _type);
    ...
    SolveResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SolveResponse),
      ) as SolveResponse;
