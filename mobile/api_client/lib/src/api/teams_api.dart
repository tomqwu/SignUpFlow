...
class TeamsApi {
  ...
  Future<Response<void>> addTeamMembers({
    ...
    final _path = r'/api/v1/teams/{team_id}/members'.replaceAll('{' r'team_id' '}', encodeQueryParameter(_serializers, teamId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(TeamMemberAdd);
      _bodyData = _serializers.serialize(teamMemberAdd, specifiedType: _type);
  ...
  Future<Response<TeamResponse>> createTeam({
    ...
    try {
      const _type = FullType(TeamCreate);
      _bodyData = _serializers.serialize(teamCreate, specifiedType: _type);
  ...
  Future<Response<void>> deleteTeam({
    ...
    final _path = r'/api/v1/teams/{team_id}'.replaceAll('{' r'team_id' '}', encodeQueryParameter(_serializers, teamId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [q] - Case-insensitive search on name and description
  ...
  Future<Response<ListResponseTeamResponse>> listTeams({
    ...
    ListResponseTeamResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListResponseTeamResponse),
      ) as ListResponseTeamResponse;
    ...
    return Response<ListResponseTeamResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> removeTeamMembers({
    ...
    try {
      const _type = FullType(TeamMemberRemove);
      _bodyData = _serializers.serialize(teamMemberRemove, specifiedType: _type);
  ...
  Future<Response<TeamResponse>> updateTeam({
    ...
    try {
      const _type = FullType(TeamUpdate);
      _bodyData = _serializers.serialize(teamUpdate, specifiedType: _type);
